...
func TestServeShellInlinesDocAndSettings(t *testing.T) {
	...
	if !strings.Contains(body, "<title>md-view Test Document — MDv</title>") {
...
func TestServeShellAgainstBuiltDist(t *testing.T) {
	...
	for _, want := range []string{
		...
		"<title>md-view Test Document — MDv</title>",
	} {
...
func TestInjectInitialStateEscaping(t *testing.T) {
	shell := []byte(`<html lang="en"><head><title>MDv</title></head><body>` +
