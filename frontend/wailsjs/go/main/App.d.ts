...
export function GetPrewarmState():Promise<main.PrewarmState>;

export function GetSettings():Promise<settings.Settings>;

export function IsWindowHidden():Promise<boolean>;

export function MarkPrewarmAsked():Promise<void>;
...
export function SetPrewarm(arg1:boolean):Promise<main.PrewarmState>;
